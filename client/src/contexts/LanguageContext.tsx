...
const translations = {
  en: {
    ...
    'footer.matherAddress': 'Prince Sultan bin Abdulaziz Road',
    'footer.matherPhone': 'Tel: 05313 53667',
  ...
  ar: {
    ...
    'footer.matherAddress': 'طريق الأمير سلطان بن عبدالعزيز',
    'footer.matherPhone': 'هاتف: 0531353667',
