...
const translations = {
  en: {
    ...
    'footer.sahafahPhone': 'Mobile: 05520 30564',
    'footer.matherBranch': 'Al-Mather Branch',
    'footer.matherAddress': 'Prince Sultan bin Abdulaziz Road, Northern Mathar, Riyadh 12314 - KSA',
    'footer.matherPhone': 'Mobile: 0531353667',
  ...
  ar: {
    ...
    'footer.sahafahPhone': 'جوال: 0552030564',
    'footer.matherBranch': 'فرع المعذر',
    'footer.matherAddress': 'طريق الأمير سلطان بن عبدالعزيز، المعذر الشمالية، الرياض 12314 - المملكة العربية السعودية',
    'footer.matherPhone': 'جوال: 0531353667',
